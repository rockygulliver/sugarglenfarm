	  ...
	  <div class="table-cell">       
		...
		<div class="nav-links">
			...
			if ( is_attachment() ) :
				...
				previous_post_link( '%link', __( '<span class="meta-nav">Previously:&nbsp;</span>%title', 'twentyfourteen' ) );
				next_post_link( '%link', __( '<span class="meta-nav">Next:&nbsp;</span>%title', 'twentyfourteen' ) );
			endif;
			?>
		</div><!-- .nav-links -->
	  </div><!-- .table-cell -->
...
function twentyfourteen_posted_on() {
	...
	printf( 'by <span class="byline"><span class="author vcard">%5$s</span></span> on <span class="entry-date"><time class="entry-date" datetime="%2$s">%3$s</time></span> ',
